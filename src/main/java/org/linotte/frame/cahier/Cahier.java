...
public class Cahier extends JPanel implements KeyListener, MouseListener {
	...
	public void init(UndoAction undoAction, RedoAction redoAction, CutL couper, CopyL copier, PasteL coller, Font font, Atelier ppere, Linotte linotte) {
		...
		new DropTarget(jEditorPaneCachier, new DragAndDropBoardListener(atelier));

		jPanelSommaire = new JPanelSommaire(this);

		styleBuffer = new StyleBuffer();

		processStyle = new ProcessStyle(linotte, this, styleBuffer);
		processStyle.start();
