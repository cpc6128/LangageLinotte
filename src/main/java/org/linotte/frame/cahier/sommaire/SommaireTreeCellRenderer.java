 ...
 * @author Ray Ryan
 * @author Scott Violet
 * @author Cpc6128 : ajout de l'attribut actif
 */
@SuppressWarnings("serial")
public class SommaireTreeCellRenderer extends JLabel implements TreeCellRenderer {

	/** Est-ce que le noeud est actif ?*/
	private boolean actif;
	private static final Color couleurActive = new Color(213, 211, 255);
	 ...
	 */
	public SommaireTreeCellRenderer() {
		inited = true;
	}
	...
	public void paint(Graphics g) {
		...
		if (bColor != null && fillBackground) {
			...
			//                g.drawRect(imageOffset, 0, getWidth() - imageOffset,
			//                           getHeight());
			//            } else {
			//                g.drawRect(0, 0, getWidth() - imageOffset,
			//                           getHeight());
			//            }
		}
