...
public class MinusculeMethodeInterne extends MethodeInterne {

	public MinusculeMethodeInterne(Acteur acteur) {
		super(acteur);
	}
	...
	public ObjetLinotte appeler(Greffon greffon, ObjetLinotte... parametres) throws Exception {
		try {
			...
			String retour = ((String) acteur.getValeur()).toLowerCase();
