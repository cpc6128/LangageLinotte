...
public class ACos extends OperationUnaire {

	@Override
	public BigDecimal calculer(BigDecimal bd) {
		return new BigDecimal(Mathematiques.angle == ANGLE.DEGREE ? Math.toDegrees(Math.acos(bd.doubleValue())) : Math.acos(bd.doubleValue()));
	}
