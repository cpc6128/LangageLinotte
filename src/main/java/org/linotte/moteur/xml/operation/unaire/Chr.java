...
public class Chr extends OperationUnaire {
	...
	public Object calculer(Job moteur, Temoin temoin, Object token_courant) throws Exception {
		...
		if (o instanceof Acteur && ((Acteur) o).getRole() == Role.NOMBRE) {
			// Traitement ascii :
			return Character.toString((char) ((BigDecimal) ((Acteur) o).getValeur()).intValue());
		} else if (o instanceof BigDecimal) {
			return Character.toString((char) ((BigDecimal) o).intValue());
		}
		throw new Exception("CHR interdit avec '" + o + "'");
	}
