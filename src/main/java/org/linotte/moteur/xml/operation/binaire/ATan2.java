...
public class ATan2 extends OperationBinaire {

	@Override
	public BigDecimal calculer(BigDecimal bd1, BigDecimal bd2) {
		return new BigDecimal(Mathematiques.angle == ANGLE.DEGREE ? Math.toDegrees(Math.atan2(bd1.doubleValue(), bd2.doubleValue())) : Math.atan2(
