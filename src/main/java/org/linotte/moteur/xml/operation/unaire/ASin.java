...
public class ASin extends OperationUnaire {

	@Override
	public BigDecimal calculer(BigDecimal bd) {
		return new BigDecimal(Mathematiques.angle == ANGLE.DEGREE ? Math.toDegrees(Math.asin(bd.doubleValue())) : Math.asin(bd.doubleValue()));
	}
