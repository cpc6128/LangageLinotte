...
public class NGroupe extends Noeud {
	...
	public boolean parse(ParserContext pc) throws Exception {
		...
		if (discriminant != null) {
			passage = analyseDiscriminant(pc, passage, discriminant, getAttribut("discriminant2"));
		}
	...
	private boolean analyseDiscriminant(ParserContext parserContext, boolean passage, String discriminant, String discriminant2) throws FinException {
