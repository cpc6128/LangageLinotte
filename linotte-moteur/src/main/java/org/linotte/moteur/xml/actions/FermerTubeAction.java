...
public class FermerTubeAction extends Action implements IProduitCartesien {

	public FermerTubeAction() {
		super();
	}
	...
	public ETAT analyse(String param, Job linotte, ItemXML[] valeurs, String[] annotations) throws Exception {
		...
		Acteur[] liste = extractionDesActeurs(Constantes.SYNTAXE_PARAMETRE_FERMER, linotte, valeurs);
		Acteur a = liste[0];

		if (!(a.getRole() == Role.ESPECE))
			throw new ErreurException(Constantes.SYNTAXE_PARAMETRE_FERMER, a.toString());
