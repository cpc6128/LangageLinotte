...
import org.linotte.moteur.xml.alize.test.TestOut;
import org.linotte.moteur.xml.analyse.ItemXML;

public class TestUnitaireOutAction extends Action implements ActionTest {

	public static final String NOM_ETAT = "test unitaire out";

	public TestUnitaireOutAction() {
		super();
	}
	...
	public ETAT analyse(String param, Job job, ItemXML[] valeurs, String[] annotations) throws Exception {
		...
		Test test = new TestOut();
		// Tester le cas de l'astérisque :
		if ("*".equals(valeurs[0].getValeurBrute())) {
			test.valeur = "*";
		} else {
