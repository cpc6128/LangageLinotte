...
public class ATan extends OperationUnaire {

	@Override
	public BigDecimal calculer(BigDecimal bd) {
		return new BigDecimal(Mathematiques.angle == ANGLE.DEGREE ? Math.toDegrees(Math.atan(bd.doubleValue())) : Math.atan(bd.doubleValue()));
	}
